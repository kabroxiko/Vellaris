...
class MapApiServerRenderPathsTest
{
    ...
    void testGenerateMapBothFailReturnsFailure() throws Exception
    {
        ...
        assertTrue(err.toString().toLowerCase().contains("simulated render failure") || err.toString().toLowerCase().contains("aspect") || err.toString().toLowerCase().contains("aspectratio") || err.toString().toLowerCase().contains("aspect_ratio"), "Expected render-related error, got: " + err);
        }
