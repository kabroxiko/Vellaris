...
/**
 * Test utility to install a fake Translation.bundle ResourceBundle for tests that need Translation.get() to succeed without loading actual
 * resource files.
 */
public final class TestTranslationBundleInstaller
{
	...
	/**
	 * Installs a fake bundle and returns an AutoCloseable that restores the previous bundle when closed. If installation fails, returns a
	 * no-op AutoCloseable.
	 */
