    ...
    if (open) {
      ...
      const rafId = requestAnimationFrame(() => {
        ...
        const getModalImageBounds = () => {
          ...
          const maxImageW = Math.max(80, window.innerWidth - viewportInset - horizontalChrome)
          const maxImageH = Math.max(80, window.innerHeight - viewportInset - verticalChrome)
