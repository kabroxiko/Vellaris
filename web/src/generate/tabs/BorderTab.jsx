      ...
      <div className="fields-column">
        ...
        >
          ...
          {renderColorControl({
            ...
            hexValue: borderColor,
            onHexChange: setBorderColor,
      ...
      <div className="fields-column">
        ...
        >
          ...
          {renderColorControl({
            ...
            hexValue: frayedBorderColor,
            onHexChange: setFrayedBorderColor,
...
BorderTab.propTypes = {
  ...
  frayedBorderColor: PropTypes.string,
  setFrayedBorderColor: PropTypes.func,
