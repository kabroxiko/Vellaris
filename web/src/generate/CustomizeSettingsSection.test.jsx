...
describe('CustomizeSettingsSection', () => {
  it('renders header and basic structure', () => {
    const opts = {
      textures: [],
      i18n: { labels: { 'ui.title.customize': 'ui.title.customize', 'ui.subtitle.customize': 'ui.subtitle.customize' }, options: { tabs: [] } },
    }
    render(<CustomizeSettingsSection values={{}} handlers={{}} options={opts} ui={{ loading: false }} />)
