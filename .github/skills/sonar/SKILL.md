...
2. Primary actions:
   ...
   - Query SonarQube API for issues using `projectKeys`, `rules`, or `issues` query parameters.
...
Usage examples:
- `/sonar scan --rule javascript:S7755` — run `sonar-scanner`, query for S7755 in the project, and prepare suggestions.
